...
class Aljazeera(CrawlSpider):
    ...
    rules = (
        Rule(SgmlLinkExtractor(restrict_xpaths=['/html/body/div/div/div/div/div/div/section/div/div/article/h1/a', '/html/body/div/div/div/div/div/div/section/div/div/div/article/div/h2/a', '//*[@id="articleHighlightList-0"]/div/div/div/article/div/h3/a', '/html/body/div/div/div/div/div/div/div/div/div[2]/div/a', '/html/body/div/div/div/div/div/div/div/div/div/div/a', '/html/body/div/div/div/div/div/div/div/div/section/div/div/div/article/div/h3/a', '/html/body/div/div/div/div/div/div/div/div/div/div/div/section/div/div[2]/article/h1/a', '/html/body/div/div/div/div/div/div/div/div/div/div/div/section/div/div/div/article/div/h2/a', '//*[@id="articleHighlightList-0"]/div/div/div/article/div/h3/a']),callback='parse_item', follow=True),
        )
